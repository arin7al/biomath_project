...
eigs = sp.solve((1 - k1*v*(1/(1+u)**2) - lam)*(k2*(1 - k3*u**2/(1+u)) - lam) - (-k1*u**2/(1+u))*(-k2*k3*v*(2*u + u**2)/(1+u)**2), lam)
...
# print sp.expand((1 - k1*v*(1/(1+u)**2) - lam)*(k2*(1 - k3*u**2/(1+u)) - lam) - (-k1*u**2/(1+u))*(-k2*k3*v*(2*u + u**2)/(1+u)**2))
